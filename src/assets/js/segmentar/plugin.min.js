                    ...
                    editor.windowManager.open({
                        ...
                        onsubmit: function(e) {
                            if (e.data.annotation) {
                                ...
                                if (anim=='subrayar'){
                                    //var segment =' <span class="annotation" style="display: block;" id="'+ id +'" data-author="' + /*TMA.author*/ 'Autor' + '" title="' + dataAnnotation.replace(/"/g,'&quot;') + '">' + selectedText + ' </span>';
                                    var segment =' <span class="annotation" style="display: block;" id="'+ id +'" data-author="' + /*TMA.author*/ 'Autor' + '" title="' + dataAnnotation.replace(/"/g,'&quot;') + '"> <a class= "fun-hover">' + selectedText + '</a></span>';
                                ...
                                if (anim=='underline'){
                                    ...
                                    var segment =' <span class="annotation" style="display: block;" id="'+ id +'" data-author="' + /*TMA.author*/ 'Autor' + '" title="' + dataAnnotation.replace(/"/g,'&quot;') + '" style="background-color: '+color+' ">' + selectedText + '</span>';
                                }
                                ...
                                editor.fire('change', {id, dataAnnotation, anim,color})
