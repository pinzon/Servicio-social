                        ...
                        onsubmit: function(e) {
                            if (e.data.annotation) {
                                ...
                                if (anim=='subrayar'){
                                    ...
                                    var segment =' <span class="annotation" style="display: line;" id="'+ id +'" data-author="' + /*TMA.author*/ 'Autor' + '" title="' + dataAnnotation.replace(/"/g,'&quot;') + '"> <a class= "fun-hover">' + selectedText + '</a></span>';
