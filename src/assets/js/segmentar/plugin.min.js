                    ...
                    editor.windowManager.open({
                        ...
                        onsubmit: function(e) {
                            if (e.data.annotation) {
                                ...
                                if (anim=='subrayar'){
                                    var segment =' <span class="annotation '+ anim +' animated" style="display: block;" data-id="'+ id +'" data-author="' + /*TMA.author*/ 'Autor' + '" title="' + dataAnnotation.replace(/"/g,'&quot;') + '"> <a class= "fun-hover" style="background-image:linear-gradient(to right, #ffffff 50%,'+color+' 50%); background-position:-100%;" >' + selectedText + '</a></span>';
                                    // console.log(segment);

                                }
                                if (anim=='underline'){
                                    // console.log1('under');
                                    var segment =' <span class="annotation '+ anim +' animated" style="display: block;" data-id="'+ id +'" data-author="' + /*TMA.author*/ 'Autor' + '" title="' + dataAnnotation.replace(/"/g,'&quot;') + '"> <a class= "fun-hover" style="text-decoration: underline;" >' + selectedText + '</a></span>';

                                }
                                else 
                                {
                                    // console.log('asdasd');
                                    var segment =' <span class="annotation '+ anim +' animated" style="display: block;" data-id="'+ id +'" data-author="' + /*TMA.author*/ 'Autor' + '" title="' + dataAnnotation.replace(/"/g,'&quot;') + '" style="background-color: '+color+' ">' + selectedText + '</span>';

                                }


                                /*En esta parte tienes que construir los span (las secciones)
                                if (type === "subrayar"){
                                    atr = "background-position";
                                    val = 0;
                                    $(parr).css({
                                ...
                                Ese pedaso de codigo es de nuestro codigo anterior, por ejemplo tienes que detectar que es subrayar y construir algo asi

                                <span id='dataAnnotatiin' (TODOS LOS ESTILOS QUE NECESITE)>selectedText</span>

                                puedes basarte en la variable que esta un poco mas abajo que se llama "segment",

                                */

                                /*Ya esta instalado animatecss pero tambien tienes qe construir las etiquetas span 
                                puedes usar jquery sin pedos
                                */
                                ...
                                // var segment =' <span class="annotation" data-id="'+ id +'" data-author="' + /*TMA.author*/ 'Autor' + '" title="' + dataAnnotation.replace(/"/g,'&quot;') + '" style="background-color: '+color+' ">' + selectedText + '</span>';
