      ...
      editor.windowManager.open({
        ...
        onsubmit: function (e) {
          if (e.data.annotation) {
            ...
            editor.selection.setContent('<span class="annotation" data-id="' + id + '" title="' + dataAnnotation.replace(/"/g, '&quot') + '" style="background-color: ' + color + ' ">' + selectedText + '</span>')
            editor.fire('change')

          } else {
            editor.windowManager.alert(' Seleccione un texto a comentar' /*TMA.errors.missing_annotation*/ )
            return false
          }
        }
      })
    } else {
      editor.windowManager.alert(' Seleccione un texto a comentar' /*TMA.errors.missing_annotation*/ , false)
    }
  }
